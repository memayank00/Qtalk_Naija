...
/**CSS */
import './TrackingMe.css';
//import ErrorBoundry from "../common/errorBoundry";


class TrackingMe extends Component {
  constructor(props){
    super(props);
              ...
              <div class=" addFrdInn">
                  <div class="row">
                    ...
                    <div class="col-4 frdListBtn">
                      <a href="" class="remove_Btn"><img src="/assets/images/remove-icon.png" alt=""/> Remove</a>
                    </div>
                  </div>
                </div> 
             </div>
...
export default connect()(TrackingMe);
