    ...
    render() {
        ...
        return (
            <tr className="odd gradeX" >
                <td> {element.title} </td>
                <td> {element.category ? element.category   :"NA"} </td>
                ...
                <td>                    
                    ...
                    <TT tooltip="Edit"><Link to={'/faq/edit/' + element._id} className=" btn btn-xs grey-mint"><i className="fa fa-pencil-square-o"></i></Link></TT>
